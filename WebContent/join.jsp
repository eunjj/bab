...
<body >
	...
	<a href= "http://localhost:8080/bab/register.jsp?wUserID=dsfds&wUserPW=dfdsafds&wUserPWConfirm=fdsfds&wUserName=fdsaf&wUserGender=1&wUserCellPhone=fdsaf&wUserEmail=fewiqrfe%40dsjaflds.dsfjd&wRestAddress=&x=37&y=22">get으로 보냄</a>>
		...
		<form action="register.jsp" method="post" name="twin">
			...
			<table width="700" height="600" cellpadding="0"
				...
				<tr>
					<td width="5%" align="center">*</td>
					<td width="15%">주 소</td>
					<td><input type="text" name="wRestAddress" placeholder="주소"
						size="70" /></td>
				</tr>
			...
			<table>
				<tr height="40">
					<td><input width="120" type="image" src="img/btn1.png" />&nbsp;<a
						href="index.jsp"><img src="img/btn2.png" width="120" /></a></td>
				</tr>
			</table>
		</form>
	</center>
